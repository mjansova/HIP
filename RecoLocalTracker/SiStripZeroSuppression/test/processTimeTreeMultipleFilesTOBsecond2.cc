...
int main(int argc, char *argv[])
{
    ...
    std::ifstream          myfile2("eventMapFULL.txt");
...
//cout << "nr of files: " << nrOfFiles << endl;
  ...
  //      if(f==NULL)
  //          cout << "address still null" << endl;
  //      cout << "is opened: " << f->IsOpen() << endl;
    ...
    TString fileName = "/opt/sbg/scratch1/cms/mjansova/store/tmp/output/sEventFileModules_" + sfrom + "_" + sto + "_part_" + spartition + "_l_" + slayer+ ".root";
